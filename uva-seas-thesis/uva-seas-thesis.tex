...
\begin{longtable}{r@{.}r@{.}lp{.8\linewidth}}
  ...
  1	& 2	& x	& Added \option{compliant} option to force best-possible compliance with \gls{SEAS} formatting guidelines; added \option{electronic} and \option{print} options; figures and tables automatically centered\\
  %\bottomrule
\end{longtable}
